...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     <h4 class=" font-weight-bold">ข้อมูลส่วนตัว</h4>
     <ul class="breadcrumbs">
         <li><a href="{{route('admin')}}" style="color:#999">รายงาน</a></li>
         <li><a href="" class="active text-primary">ข้อมูลส่วนตัว</a></li>
     </ul>
   </div>
   <div class="card-body">
        <div class="row">
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="role" class="col-form-label">ตำแหน่ง</label>
                          <select name="role" class="form-control">
                              <option value="">-----เลือก ตำแหน่ง-----</option>
