...
<div class="card">
    <h5 class="card-header">แก้ไขสินค้า</h5>
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              @foreach($items as $item)              
                ...
                // dd($data);
                @endphp
              <option value="S"  @if( in_array( "S",$data ) ) selected @endif>Small (1-4 cm.)</option>
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Medium (4-6 cm.)</option>
              <option value="L"  @if( in_array( "L",$data ) ) selected @endif>Large(6-9 cm.)</option>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default" {{(($product->condition=='default')? 'selected':'')}}>ปกติ</option>
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>ใหม่</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>ขายดี</option>
          </select>
        </div>
