...
@section('title','ร้านอุปกรณ์ตกปลา || Banner Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">รายชื่อ แบรนด์</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
                ...
                <tr>
                    ...
                    {{-- <div class="modal fade" id="delModal{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="#delModal{{$user->id}}Label" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content"><!-- เศรษฐ์ เกิดแสง 062-5952829 -->
        ...
        @else
          <h6 class="text-center">ไม่พบ ป้ายสินค้า!!! โปรดสร้างป้ายสินค้าก่อน</h6>
        @endif
      </div>
    </div>
</div>
