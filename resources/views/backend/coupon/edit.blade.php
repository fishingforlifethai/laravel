...
<div class="card">
    <h5 class="card-header">แก้ไขคูปอง</h5>
    <div class="card-body">
      <form method="post" action="{{route('coupon.update',$coupon->id)}}">
        @csrf 
        @method('PATCH')
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">รหัสคูปอง <span class="text-danger">*</span></label>
          ...
          <div class="form-group"><!-- เศรษฐ์ เกิดแสง 062-5952829 -->
              <label for="type" class="col-form-label">ประเภท <span class="text-danger">*</span></label>
          ...
          <div class="form-group">
              <label for="inputTitle" class="col-form-label">มูลค่า <span class="text-danger">*</span></label>
