...
@section('title','ร้านอุปกรณ์ตกปลา || Brand Page')
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">รายชื่อแบรนด์</h6>
    ...
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">หาแบรนด์ไม่พบ!!! โปรดสร้างแบรนด์ก่อน</h6>
        @endif
      </div>
    </div>
</div>
