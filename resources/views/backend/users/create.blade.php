...
<div class="card">
    <h5 class="card-header">เพิ่มผู้ใช้งาน</h5>
    <div class="card-body">
      <form method="post" action="{{route('users.store')}}">
        ...
        <div class="form-group">
            <label for="inputPassword" class="col-form-label">พาสเวิร์ด</label>
        ...
        <div class="form-group mb-3">
          <button type="reset" class="btn btn-warning">รีเซ็ท</button>
           <button class="btn btn-success" type="submit">สร้างข้อมมูล</button>
        </div>
      </form>
    </div>
</div>
