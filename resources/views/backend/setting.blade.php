...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
          <label for="short_des" class="col-form-label">อธิบาย <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="description" class="col-form-label">รายละเอียด <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="inputPhoto" class="col-form-label">โลโก้ <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="address" class="col-form-label">ที่อยู่ <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          <label for="phone" class="col-form-label">เบอร์โทรศัพ <span class="text-danger">*</span></label>
