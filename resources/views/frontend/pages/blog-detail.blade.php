                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">บทความ</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>โดย {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comment ({{$post->allComments->count()}})</a></span>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">โพสคอมเมน</span><span class="comment_btn reply" style="display: none;">โพสอีกครั้ง</span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                                จำเป็นต้อง <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">เข้าสู่ระบบ</a> หรือ <a style="color:blue" href="{{route('register.form')}}">สมัครสมาชิก</a> เพื่อคอมเมน
                            ...
                            <div class="col-12">
                                <div class="comments">
                                    <h3 class="comment-title">คอมเมน ({{$post->allComments->count()}})</h3>
                                    <!-- Single Comment -->
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">ข่าวสารใหม่ๆ</h3>
                            <div class="letter-inner">
                                <h4>ติดตามเพื่อรับข่าวสาร <br> อัปเดตใหม่ๆ</h4>
                                <form action="{{route('subscribe')}}" method="POST">
                                    @csrf
                                    <div class="form-inner">
                                        <input type="email" name="email" placeholder="Enter your email">
                                        <button type="submit" class="btn mt-2">สร้างข้อมูล</button>
                                    </div>
                                </form>
                            </div>
                        </div>
