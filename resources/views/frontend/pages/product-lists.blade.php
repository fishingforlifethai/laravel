						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
											...
											<div class="row">
												...
												<div class="col-lg-8 col-md-6 col-12">
													<div class="list-content">
														...
														<a href="javascript:void(0)" class="btn cart" data-id="{{$product->id}}">ซื้อเลย!</a>
													</div>
												</div>
											</div>
										</div>
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">ขออภัย ไม่มีสินค้าตามช่วงที่กำหนด ลองเลือกอันอื่นเพื่อดูผลลัพธ์เพิ่มเติม</h4>
								@endif
							</div>
							 <div class="row">
